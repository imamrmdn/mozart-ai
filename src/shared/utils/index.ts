...
A groundbreaking platform harnessing *artificial intelligence* to make music creation accessible to everyone.
`;
...
const instructions = `
How to Jam with Mozart AI 🎶

1.Choose Your Vibe
   Pick the genre or mood you’re feelin’.

2.Let Mozart AI Work Its Magic
   Kick back while we craft your custom beats.

3.Download & Jam Out
   Grab your track and vibe to your own masterpiece!

🎧 Ready? Let’s make some noise! 🚀
`;
